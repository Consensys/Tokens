...
contract('SafeEIP20', (accounts) => {
  ...
  //Starting from this line, the following tests are the same tests applied to EIP20.
  ...
  it('creation: should succeed in creating over 2^256 - 1 (max) tokens', async () => {
    // 2^256 - 1
    const HST2 = await SafeEIP20Abstraction.new('115792089237316195423570985008687907853269984665640564039457584007913129639935', 'Simon Bucks', 1, 'SBX', { from: accounts[0] });
